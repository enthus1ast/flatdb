...
if contacts.nodes.len == 0:
  # if no data there we create some testdata.
  discard contacts.append(%* {"name": "Klaus", "phone": "012 8378 89", "country": "Germany", "email": "Klaus@example.org"})
